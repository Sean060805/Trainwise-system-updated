<?php
/* ===================================================================
   COL EVALUATION — Department view for College of Law
   -------------------------------------------------------------------
   UI designed to match COL.php (violet/gold accent, dark slate rail, 
...
<head>
  ...
  <title>COL Evaluation · LSPU TNA</title>
  ...
  <!-- TAILWIND (CDN) — palette extended to enterprise tokens with COL violet/gold accent -->
  <link rel="stylesheet" href="../assets/css/tw-28.css">

  <style>
    /* ==========================================================
       DESIGN SYSTEM — shared with COL.php
       ========================================================== */
    ...
    :root {
      ...
      --rail:#0f0a1a; --rail-2:#1a0f2e; --rail-line:rgba(148,163,184,0.14);
    ...
    *,*::before,*::after { box-sizing:border-box; -webkit-tap-highlight-color:transparent; }
    ...
    /* 4. SIDEBAR — COL violet/gold accent version */
    ...
    .rail-logo-fallback { width:38px; height:38px; border-radius:10px; flex-shrink:0; background:linear-gradient(135deg, var(--colviolet), var(--colgold)); display:flex; align-items:center; justify-content:center; }
    ...
    .rail-link.active { background:linear-gradient(100deg, rgba(76,29,149,0.26), rgba(76,29,149,0.08)); color:#fff; border-color:rgba(218,165,32,0.35); }
  ...
  .rail-badge { margin-left:auto; background:var(--bad); color:#fff; font-size:0.68rem; font-weight:700; padding:0.15rem 0.48rem; border-radius:999px; line-height:1.4; flex-shrink:0; }
    ...
    .avatar { width:34px; height:34px; border-radius:9px; flex-shrink:0; background:linear-gradient(135deg, var(--colviolet), var(--colgold)); color:#fff; font-weight:700; font-size:0.85rem; display:flex; align-items:center; justify-content:center; font-family:'Plus Jakarta Sans',sans-serif; }
    ...
    .stat.a-violet   { --stat-accent:linear-gradient(90deg, #6d28d9, #4c1d95); }
    .stat.a-gold     { --stat-accent:linear-gradient(90deg, #e8c96e, #daa520); }
    ...
    .ico-violet   { background:var(--colviolet-soft); color:var(--colviolet); }
    .ico-gold     { background:var(--colgold-soft); color:#854d0e; }
    ...
    .btn-violet { background:var(--colviolet); color:#fff; box-shadow:0 8px 18px -10px rgba(76,29,149,0.6); }
    .btn-violet:hover { background:#3b0f7a; }
    .btn-gold { background:var(--colgold); color:#fff; box-shadow:0 8px 18px -10px rgba(218,165,32,0.6); }
    ...
    .evaluate-btn { display:inline-flex; align-items:center; gap:0.4rem; background:var(--colviolet); color:#fff; padding:0.5rem 0.95rem; border-radius:var(--radius-sm); font-size:0.82rem; font-weight:600; border:none; cursor:pointer; box-shadow:0 8px 18px -10px rgba(76,29,149,0.6); transition:background 0.18s var(--ease), transform 0.12s var(--ease); }
    .evaluate-btn:hover { background:#3b0f7a; }
    ...
    .badge-submitted { background:var(--colviolet-soft); color:var(--accent-ink); }
    .badge-approved { background:var(--ok-soft); color:var(--ok-ink); }
    .badge-rejected { background:var(--bad-soft); color:var(--bad-ink); }
    .badge-department { background:var(--colviolet-soft); color:var(--accent-ink); padding:0.32rem 0.7rem; border-radius:999px; font-size:0.7rem; font-weight:700; letter-spacing:0.02em; }
    .badge-teaching { background:#e0f2fe; color:#0369a1; }
    .badge-non-teaching { background:var(--colgold-soft); color:#854d0e; }
    ...
    .emp-avatar { width:38px; height:38px; border-radius:10px; background:var(--colviolet-soft); color:var(--accent-ink); display:flex; align-items:center; justify-content:center; font-size:1.1rem; flex-shrink:0; }
    ...
    .modal-head h3 i { color:var(--colgold); }
...
<div class="app" id="app">
  ...
  <!-- ---------- SIDEBAR (COL Violet/Gold Accent) ---------- -->
  <aside class="rail" id="rail">
    <div class="rail-brand">
      <div style="display:flex;align-items:center;gap:0.35rem;flex-shrink:0;">
        ...
        <img src="../images/col-logo.png" alt="COL" class="rail-logo" style="width:32px;height:32px;padding:3px;"
             onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
        <div class="rail-logo-fallback" style="display:none;width:32px;height:32px;">
          <i class="ri-scale-line text-white text-lg"></i>
        </div>
      </div>
    ...
    <nav class="rail-nav">
      ...
      <a href="COL_Assessment Form.php" class="rail-link">
      ...
      <a href="col_eval.php" class="rail-link active">
      ...
      <div class="content">
        ...
        <div class="page-head">
          <div>
            ...
            <h2>COL Faculty Evaluations</h2>
            <p>View and manage COL faculty training evaluations — <span class="num"><?= $total_faculty ?></span> faculty members</p>
          </div>
        </div>
        ...
        <div class="grid-stats">
          <div class="stat a-violet">
            <div class="stat-body">
              ...
              <div class="stat-ico ico-violet"><i class="ri-team-line"></i></div>
            </div>
          </div>
          ...
          <div class="stat a-gold">
            <div class="stat-body">
              ...
              <div class="stat-ico ico-gold"><i class="ri-time-line"></i></div>
            </div>
          </div>
        </div>
                  ...
                  <tr>
                    <td colspan="6">
                      <div class="empty">
                        ...
                        <h4><?= $error_message ? 'Database Error' : 'No COL Faculty Found' ?></h4>
                        <p><?= $error_message ? 'Please check your database connection.' : 'No COL faculty members with teaching status found.' ?></p>

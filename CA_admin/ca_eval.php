<?php
/* ===================================================================
   CA EVALUATION — Department view for College of Agriculture
   -------------------------------------------------------------------
   UI designed to match CA.php (green accent, dark slate rail, 
...
<head>
  ...
  <title>CA Evaluation · LSPU TNA</title>
  ...
  <!-- TAILWIND (CDN) — palette extended to enterprise tokens with CA green accent -->
  <link rel="stylesheet" href="../assets/css/tw-25.css">

  <style>
    /* ==========================================================
       DESIGN SYSTEM — shared with CA.php
       ========================================================== */
    ...
    *,*::before,*::after { box-sizing:border-box; -webkit-tap-highlight-color:transparent; }
    ...
    /* 4. SIDEBAR — CA green accent version */
  ...
  .rail-badge { margin-left:auto; background:var(--bad); color:#fff; font-size:0.68rem; font-weight:700; padding:0.15rem 0.48rem; border-radius:999px; line-height:1.4; flex-shrink:0; }
    ...
    .evaluate-btn { display:inline-flex; align-items:center; gap:0.4rem; background:var(--green); color:#fff; padding:0.5rem 0.95rem; border-radius:var(--radius-sm); font-size:0.82rem; font-weight:600; border:none; cursor:pointer; box-shadow:0 8px 18px -10px rgba(22,163,74,0.6); transition:background 0.18s var(--ease), transform 0.12s var(--ease); }
    .evaluate-btn:hover { background:#15803d; }
    ...
    .badge-department { background:var(--green-soft); color:#14532d; padding:0.32rem 0.7rem; border-radius:999px; font-size:0.7rem; font-weight:700; letter-spacing:0.02em; }
...
<div class="app" id="app">
  ...
  <aside class="rail" id="rail">
    ...
    <nav class="rail-nav">
      ...
      <a href="ca_eval.php" class="rail-link active">
      ...
      <div class="content">
        ...
        <div class="page-head">
          <div>
            ...
            <h2>CA Faculty Evaluations</h2>
            <p>View and manage CA faculty training evaluations — <span class="num"><?= $total_faculty ?></span> faculty members</p>
          </div>
        </div>
                  ...
                  <tr>
                    <td colspan="6">
                      <div class="empty">
                        ...
                        <h4><?= $error_message ? 'Database Error' : 'No CA Faculty Found' ?></h4>
                        <p><?= $error_message ? 'Please check your database connection.' : 'No CA faculty members with teaching status found.' ?></p>

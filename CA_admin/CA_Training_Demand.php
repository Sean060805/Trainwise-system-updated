<?php
/* =============================================================================
   LSPU — CA TRAINING DEMAND (dedicated page)
   -----------------------------------------------------------------------------
   2026-09-04 - split out of CA.php's dashboard, same treatment as
   ...
   dashboard scroll. CA.php keeps a slim teaser card linking here.
   ============================================================================= */
...
/* -----------------------------------------------------------------------------
   TRAINING DEMAND FORWARDED TO CA — identical to CA.php's own block.
   ----------------------------------------------------------------------------- */
...
<head>
  ...
  <title>CA Training Demand · LSPU TNA</title>
  ...
  <link rel="stylesheet" href="../assets/css/tw-13.css">

  <!-- Design system — same shell as CA.php, recolored via this
  ...
  <style>
    :root {
      ...
      --accent: #16a34a; --accent-600: #16a34a; --accent-700: #15803d; --accent-soft: #dcfce7; --accent-ink: #14532d;
...
<div class="app" id="app">
  ...
  <aside class="rail" id="rail">
    ...
    <nav class="rail-nav">
      ...
      <a href="CA_Training_Demand.php" class="rail-link active">
      ...
      <div class="content">
        ...
        <div class="page-head">
          <div>
            ...
            <p>Trainings HR has forwarded to CA because your own faculty/staff requested them — report back once you've found a provider.</p>
          </div>
        ...
        <p style="font-size:0.8rem;color:var(--muted);margin:-0.6rem 0 1.1rem;">
          Already found something on your own, with no employee request behind it? <a href="#" onclick="openPostOpportunityModal();return false;" style="color:var(--accent);font-weight:600;">Post it as an opportunity</a> instead of a group chat - your <?= htmlspecialchars('CA') ?> staff will see it and can sign up right in the system.
        </p>
        </div>

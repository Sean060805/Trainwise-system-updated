<?php
/* =============================================================================
   LSPU — CFND TRAINING DEMAND (dedicated page)
   -----------------------------------------------------------------------------
   2026-09-04 - split out of CFND.php's dashboard, same treatment as
   ...
   dashboard scroll. CFND.php keeps a slim teaser card linking here.
   ============================================================================= */
...
/* -----------------------------------------------------------------------------
   TRAINING DEMAND FORWARDED TO CFND — identical to CFND.php's own block.
   ----------------------------------------------------------------------------- */
...
<head>
  ...
  <title>CFND Training Demand · LSPU TNA</title>
  ...
  <link rel="stylesheet" href="../assets/css/tw-8.css">

  <!-- Design system — same shell as CFND.php, recolored via this
  ...
  <style>
    :root {
      ...
      --accent: #ec4899; --accent-600: #ec4899; --accent-700: #db2777; --accent-soft: #fce7f3; --accent-ink: #9d174d;
...
<div class="app" id="app">
  ...
  <aside class="rail" id="rail">
    ...
    <nav class="rail-nav">
      ...
      <a href="CFND_Training_Demand.php" class="rail-link active">
            ...
            <div class="dropdown-head">
              <div style="display:flex;align-items:center;gap:0.65rem;">
                ...
                <div style="line-height:1.2;">
                  ...
                  <div style="font-size:0.72rem;color:var(--muted);">College of Food, Nutrition and Dietetics</div>
                </div>
              </div>
            </div>
      ...
      <div class="content">
        ...
        <div class="page-head">
          <div>
            ...
            <p>Trainings HR has forwarded to CFND because your own faculty/staff requested them — report back once you've found a provider.</p>
          </div>
        ...
        <p style="font-size:0.8rem;color:var(--muted);margin:-0.6rem 0 1.1rem;">
          Already found something on your own, with no employee request behind it? <a href="#" onclick="openPostOpportunityModal();return false;" style="color:var(--accent);font-weight:600;">Post it as an opportunity</a> instead of a group chat - your <?= htmlspecialchars('CFND') ?> staff will see it and can sign up right in the system.
        </p>
        </div>

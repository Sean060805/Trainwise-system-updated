...
require('../fpdf.php');
require('../config.php');
// 2026-09-03 - config.php already starts the session (guarded); calling
// session_start() again unconditionally here printed a visible Notice
// into the response, and that leaked output is exactly what made FPDF's
// own "some data has already been output" check fail on every PDF
// export - same bug already fixed in the root Training Needs Assessment
// Form_pdf.php on 2026-09-02, which this per-college copy never got.

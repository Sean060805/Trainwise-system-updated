<?php
/* ===================================================================
   CFND EVALUATION — Department view for College of Food Nutrition and Dietetics
   -------------------------------------------------------------------
   UI designed to match CFND.php (pink accent, dark slate rail, 
...
<head>
  ...
  <title>CFND Evaluation · LSPU TNA</title>
  ...
  <!-- TAILWIND (CDN) — palette extended to enterprise tokens with CFND pink accent -->
  <link rel="stylesheet" href="../assets/css/tw-21.css">

  <style>
    /* ==========================================================
       DESIGN SYSTEM — shared with CFND.php
       ========================================================== */
    ...
    *,*::before,*::after { box-sizing:border-box; -webkit-tap-highlight-color:transparent; }
    ...
    /* 4. SIDEBAR — CFND pink accent version */
  ...
  .rail-badge { margin-left:auto; background:var(--bad); color:#fff; font-size:0.68rem; font-weight:700; padding:0.15rem 0.48rem; border-radius:999px; line-height:1.4; flex-shrink:0; }
    ...
    .evaluate-btn { display:inline-flex; align-items:center; gap:0.4rem; background:var(--pink); color:#fff; padding:0.5rem 0.95rem; border-radius:var(--radius-sm); font-size:0.82rem; font-weight:600; border:none; cursor:pointer; box-shadow:0 8px 18px -10px rgba(236,72,153,0.6); transition:background 0.18s var(--ease), transform 0.12s var(--ease); }
    .evaluate-btn:hover { background:#db2777; }
    ...
    .badge-submitted { background:#fce7f3; color:#9d174d; }
    .badge-approved { background:var(--ok-soft); color:var(--ok-ink); }
    .badge-rejected { background:var(--bad-soft); color:var(--bad-ink); }
    .badge-department { background:var(--pink-soft); color:#9d174d; padding:0.32rem 0.7rem; border-radius:999px; font-size:0.7rem; font-weight:700; letter-spacing:0.02em; }
    .badge-teaching { background:#e0f2fe; color:#0369a1; }
    .badge-non-teaching { background:#fce7f3; color:#9d174d; }
    ...
    .modal-head h3 i { color:var(--pink); }
...
<div class="app" id="app">
  ...
  <aside class="rail" id="rail">
    ...
    <nav class="rail-nav">
      ...
      <a href="cfnd_eval.php" class="rail-link active">
      ...
      <div class="content">
        ...
        <div class="page-head">
          <div>
            ...
            <h2>CFND Faculty Evaluations</h2>
            <p>View and manage CFND faculty training evaluations — <span class="num"><?= $total_faculty ?></span> faculty members</p>
          </div>
        </div>
        ...
        <div class="grid-stats">
          ...
          <div class="stat a-white">
            <div class="stat-body">
              ...
              <div class="stat-ico ico-white"><i class="ri-time-line"></i></div>
            </div>
          </div>
        </div>
                  ...
                  <tr>
                    <td colspan="6">
                      <div class="empty">
                        ...
                        <h4><?= $error_message ? 'Database Error' : 'No CFND Faculty Found' ?></h4>
                        <p><?= $error_message ? 'Please check your database connection.' : 'No CFND faculty members with teaching status found.' ?></p>
...
<div class="modal" id="evaluation-modal">
  <div class="modal-box">
    ...
    <div class="modal-foot">
      ...
      <button type="button" class="btn btn-pink" id="modal-print-btn"><i class="ri-printer-line"></i> Print</button>
    </div>
  </div>
</div>

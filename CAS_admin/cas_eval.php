<?php
/* ===================================================================
   CAS EVALUATION — Department view for College of Arts & Sciences
   -------------------------------------------------------------------
   UI designed to match CAS.php (purple accent, dark slate rail, 
...
<head>
  ...
  <title>CAS Evaluation · LSPU TNA</title>
  ...
  <!-- TAILWIND (CDN) — palette extended to enterprise tokens with CAS purple accent -->
  <link rel="stylesheet" href="../assets/css/tw-24.css">

  <style>
    /* ==========================================================
       DESIGN SYSTEM — shared with CAS.php
       ========================================================== */
    ...
    *,*::before,*::after { box-sizing:border-box; -webkit-tap-highlight-color:transparent; }
    ...
    /* 4. SIDEBAR — CAS purple accent version */
  ...
  .rail-badge { margin-left:auto; background:var(--bad); color:#fff; font-size:0.68rem; font-weight:700; padding:0.15rem 0.48rem; border-radius:999px; line-height:1.4; flex-shrink:0; }
    ...
    .evaluate-btn { display:inline-flex; align-items:center; gap:0.4rem; background:var(--purple); color:#fff; padding:0.5rem 0.95rem; border-radius:var(--radius-sm); font-size:0.82rem; font-weight:600; border:none; cursor:pointer; box-shadow:0 8px 18px -10px rgba(109,40,217,0.6); transition:background 0.18s var(--ease), transform 0.12s var(--ease); }
    .evaluate-btn:hover { background:#4c1d95; }
    ...
    .badge-submitted { background:#ddd6fe; color:#5b21b6; }
    .badge-approved { background:var(--ok-soft); color:var(--ok-ink); }
    .badge-rejected { background:var(--bad-soft); color:var(--bad-ink); }
    .badge-department { background:var(--purple-soft); color:#4c1d95; padding:0.32rem 0.7rem; border-radius:999px; font-size:0.7rem; font-weight:700; letter-spacing:0.02em; }
...
<div class="app" id="app">
  ...
  <aside class="rail" id="rail">
    ...
    <nav class="rail-nav">
      ...
      <a href="cas_eval.php" class="rail-link active">
      ...
      <div class="content">
        ...
        <div class="page-head">
          <div>
            ...
            <h2>CAS Faculty Evaluations</h2>
            <p>View and manage CAS faculty training evaluations — <span class="num"><?= $total_faculty ?></span> faculty members</p>
          </div>
        </div>
                  ...
                  <tr>
                    <td colspan="6">
                      <div class="empty">
                        ...
                        <h4><?= $error_message ? 'Database Error' : 'No CAS Faculty Found' ?></h4>
                        <p><?= $error_message ? 'Please check your database connection.' : 'No CAS faculty members with teaching status found.' ?></p>
...
<div class="modal" id="evaluation-modal">
  <div class="modal-box">
    ...
    <div class="modal-foot">
      ...
      <button type="button" class="btn btn-purple" id="modal-print-btn"><i class="ri-printer-line"></i> Print</button>
    </div>
  </div>
</div>

<?php
/* ===================================================================
   CTE EVALUATION — Department view for College of Teacher Education
   -------------------------------------------------------------------
   UI designed to match CTE.php (blue/yellow accent, dark slate rail, 
...
<head>
  ...
  <title>CTE Evaluation · LSPU TNA</title>
  ...
  <!-- TAILWIND (CDN) — palette extended to enterprise tokens with CTE blue/yellow accent -->
  <link rel="stylesheet" href="../assets/css/tw-14.css">

  <style>
    /* ==========================================================
       DESIGN SYSTEM — shared with CTE.php
       ========================================================== */
    ...
    *,*::before,*::after { box-sizing:border-box; -webkit-tap-highlight-color:transparent; }
    ...
    /* 4. SIDEBAR — CTE blue/yellow accent version */
  ...
  .rail-badge { margin-left:auto; background:var(--bad); color:#fff; font-size:0.68rem; font-weight:700; padding:0.15rem 0.48rem; border-radius:999px; line-height:1.4; flex-shrink:0; }
    ...
    .evaluate-btn { display:inline-flex; align-items:center; gap:0.4rem; background:var(--cteblue); color:#fff; padding:0.5rem 0.95rem; border-radius:var(--radius-sm); font-size:0.82rem; font-weight:600; border:none; cursor:pointer; box-shadow:0 8px 18px -10px rgba(59,130,246,0.6); transition:background 0.18s var(--ease), transform 0.12s var(--ease); }
    .evaluate-btn:hover { background:#2563eb; }
    ...
    .badge-department { background:var(--cteblue-soft); color:var(--cteblue); padding:0.32rem 0.7rem; border-radius:999px; font-size:0.7rem; font-weight:700; letter-spacing:0.02em; }
    ...
    .modal-head h3 i { color:var(--cteblue); }
...
<div class="app" id="app">
  ...
  <!-- ---------- SIDEBAR (CTE Blue/Yellow Accent) ---------- -->
  <aside class="rail" id="rail">
    ...
    <nav class="rail-nav">
      ...
      <a href="cte_eval.php" class="rail-link active">
      ...
      <div class="content">
        ...
        <div class="page-head">
          <div>
            ...
            <h2>CTE Faculty Evaluations</h2>
            <p>View and manage CTE faculty training evaluations — <span class="num"><?= $total_faculty ?></span> faculty members</p>
          </div>
        </div>
        ...
        <div class="grid-stats">
          ...
          <div class="stat a-rose">
            <div class="stat-body">
              ...
              <div class="stat-ico ico-rose"><i class="ri-time-line"></i></div>
            </div>
          </div>
        </div>
                  ...
                  <tr>
                    <td colspan="6">
                      <div class="empty">
                        ...
                        <h4><?= $error_message ? 'Database Error' : 'No CTE Faculty Found' ?></h4>
                        <p><?= $error_message ? 'Please check your database connection.' : 'No CTE faculty members with teaching status found.' ?></p>
...
<div class="modal" id="evaluation-modal">
  <div class="modal-box">
    ...
    <div class="modal-foot">
      ...
      <button type="button" class="btn btn-cteblue" id="modal-print-btn"><i class="ri-printer-line"></i> Print</button>
    </div>
  </div>
</div>

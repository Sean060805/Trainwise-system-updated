<?php
// This file contains the HTML structure for displaying evaluation details for users
// Note: This file is included by get_evaluation_details.php, so we don't need to start another PHP session
?>

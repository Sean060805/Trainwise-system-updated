<?php
/* =============================================================================
   LSPU — COF TRAINING DEMAND (dedicated page)
   -----------------------------------------------------------------------------
   2026-09-04 - split out of COF.php's dashboard, same treatment as
   ...
   dashboard scroll. COF.php keeps a slim teaser card linking here.
   ============================================================================= */
...
/* -----------------------------------------------------------------------------
   TRAINING DEMAND FORWARDED TO COF — identical to COF.php's own block.
   ----------------------------------------------------------------------------- */
...
<head>
  ...
  <title>COF Training Demand · LSPU TNA</title>
  ...
  <link rel="stylesheet" href="../assets/css/tw-4.css">

  <!-- Design system — same shell as COF.php, recolored via this
  ...
  <style>
    :root {
      ...
      --accent: #2563eb; --accent-600: #2563eb; --accent-700: #1d4ed8; --accent-soft: #dbeafe; --accent-ink: #1e3a8a;
...
<div class="app" id="app">
  ...
  <aside class="rail" id="rail">
    ...
    <nav class="rail-nav">
      ...
      <a href="COF_Training_Demand.php" class="rail-link active">
      ...
      <div class="content">
        ...
        <div class="page-head">
          <div>
            ...
            <p>Trainings HR has forwarded to COF because your own faculty/staff requested them — report back once you've found a provider.</p>
          </div>
        ...
        <p style="font-size:0.8rem;color:var(--muted);margin:-0.6rem 0 1.1rem;">
          Already found something on your own, with no employee request behind it? <a href="#" onclick="openPostOpportunityModal();return false;" style="color:var(--accent);font-weight:600;">Post it as an opportunity</a> instead of a group chat - your <?= htmlspecialchars('COF') ?> staff will see it and can sign up right in the system.
        </p>
...
// 2026-09-06 - generalized so "Post a Training Opportunity" can reuse the
// exact same validation instead of a second copy (this used to be hardcoded
// to the Report Found modal's field ids only).
